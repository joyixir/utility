...
namespace Joyixir.Utility.Utils.Screenshot
{
    public static class GameViewUtils
    {
        ...
        static GameViewUtils()
        {
            ...
            s_GameView_SizeSelectionCallback =
                s_GameViewType
            ...
            s_GameViewSizeSingleType =
                typeof (ScriptableSingleton<>)
                    .MakeGenericType(s_GameViewSizesType);
            s_GameViewSizes_GetGroup =
                s_GameViewSizesType.GetMethod("GetGroup");
        ...
        public static bool TrySetSize(string sizeText, GameViewSizeGroupType currentView=GameViewSizeGroupType.Standalone)
        {
        ...
        public static void SetSizeIndex(int index)
        {
            ...
            if (lastSceneView != null) lastSceneView.Focus();
        ...
        /// </summary>
        public static int
        FindSize(GameViewSizeGroupType sizeGroupType, string text)
        {
        ...
        {
            return s_GameViewSizes_GetGroup
                .Invoke(s_GameViewSizes_instance, new object[] { (int) type });
        }
        #endif
    }
}